package com.kamsiz.runningbird;
...
public class Runningbird extends ApplicationAdapter {
	SpriteBatch batch;
	Texture background;
	Texture bird;
	Texture enemy;
	...
	public void create () {
		...
		background= new Texture("full.png");
		bird=new Texture("kar.png");
